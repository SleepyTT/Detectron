...
__C.TRAIN.DATASET_INFO.NAME = 'train'
__C.TRAIN.DATASET_INFO.DATA_IM_DIR = ''
__C.TRAIN.DATASET_INFO.DATA_ANN_FN = ''
__C.TRAIN.DATASET_INFO.DATA_RAW_DIR = ''
__C.TRAIN.DATASET_INFO.DATA_DEVKIT_DIR = ''
__C.TRAIN.DATASET_INFO.IM_PREFIX = ''
...
# Testing (during training) period
# Number of itereations for testing on val during train
__C.TRAIN.TEST_ITERS = 100
...
__C.TEST.DATASET_INFO.NAME = 'test'
__C.TEST.DATASET_INFO.DATA_IM_DIR = ''
__C.TEST.DATASET_INFO.DATA_ANN_FN = ''
__C.TEST.DATASET_INFO.DATA_RAW_DIR = ''
__C.TEST.DATASET_INFO.DATA_DEVKIT_DIR = ''
__C.TEST.DATASET_INFO.IM_PREFIX = ''
